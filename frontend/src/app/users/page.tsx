  // 1. Importamos o tipo 'User' junto com 'getUsers'
  import { getUsers, User } from "@/lib/api";
  import Link from "next/link";

  // Adicionamos esta linha para evitar erros de build se a API estiver offline
  export const dynamic = 'force-dynamic';

  export default async function UsersPage() {
    // 2. Declaramos a variável 'users' corretamente com seu tipo
    let users: User[] = [];
    let error = null;
